...
regionCuts['Baseline']           = [(0,inf), (150,300), (1,inf), (0,inf), (1,inf), (0,inf), (0,inf),     (0.3,inf),        (-inf,inf),        (0,0 ),     (0,inf),     (0,inf),     (0,inf),     (0,0),    (candPtCut,inf), (0,2.4),      (-inf,inf), (-1,inf)]

regionCuts['BaselinePixOnly']    = [(0,inf), (150,300), (1,inf), (0,inf), (1,inf), (1,inf), (0,inf),     (0.3,inf),        (-inf,inf),          (0,0),     (0,inf),     (0,inf),     (0,inf),     (0,0),    (candPtCut,inf), (0,2.4),      (-inf,inf), (-1,inf)]
regionCuts['BaselinePixAndStrips']=[(0,inf), (150,300), (1,inf), (0,inf), (1,inf), (0,inf), (1,inf),     (0.3,inf),        (-inf,inf),          (0,0),     (0,inf),     (0,inf),     (0,inf),     (0,0),    (candPtCut,inf), (0,2.4),      (-inf,inf), (-1,inf)]
...
for ientry in range(nentries):
	...
	for itrack, track in enumerate(c.tracks):
		...
		if dtstatus==2: disappearingTracks.append([track,dtstatus,c.tracks_deDxHarmonic2pixel[itrack]])		
	...
	for iel, ele in enumerate(c.Electrons):
		...
		SmearedElectrons.append([smearedEl,c.Electrons_charge[iel],c.tracks_deDxHarmonic2pixel[matchedTrk[2]],c.tracks_deDxHarmonic2pixel[matchedTrk[2]]])
	...
	for ilep, lep in enumerate(c.Muons):
		...
		SmearedMuons.append([smearedMu,c.Muons_charge[ilep],c.tracks_deDxHarmonic2pixel[matchedTrk[2]],c.tracks_deDxHarmonic2pixel[matchedTrk[2]]])
	...
	for ipi, pi in enumerate(c.TAPPionTracks):
		...
		SmearedPions.append([smearedPi,c.TAPPionTracks_charge[ipi],c.tracks_deDxHarmonic2pixel[matchedTrk[2]],c.tracks_deDxHarmonic2pixel[matchedTrk[2]]])
	...
	for elething in SmearedElectrons:
		elec, elcharge, eldedxPixel, eldedxPixel = elething
	...
	for muonthing in SmearedMuons:
		muon, mucharge, mudedxPixel, mudedxPixel = muonthing
		adjustedMht = TLorentzVector()
		adjustedMht.SetPxPyPzE(0,0,0,0)
		adjustedJets = []
		adjustedHt = 0
	...
	for pithing in SmearedPions:
		pion, picharge, pidedxPixel, pidedxPixel = pithing
		adjustedMht = TLorentzVector()
		adjustedMht.SetPxPyPzE(0,0,0,0)
		adjustedJets = []
		adjustedHt = 0
