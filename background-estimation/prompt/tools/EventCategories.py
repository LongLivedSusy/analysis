...
skimDirectory = 'output/'
#sigfilelist = glob('Signal/*.root')
sigfilelist = glob('output/Signal/*.root')
...
DYJets_SubcategoryChainDict_ = {}
DYJets_SubcategoryChainDict_['DYJetsToLL_M-50_HT-100to200'] = TChain('tEvent')
DYJets_SubcategoryChainDict_['DYJetsToLL_M-50_HT-200to400'] = TChain('tEvent')
DYJets_SubcategoryChainDict_['DYJetsToLL_M-50_HT-400to600'] = TChain('tEvent')
DYJets_SubcategoryChainDict_['DYJetsToLL_M-50_HT-600to800'] = TChain('tEvent')
DYJets_SubcategoryChainDict_['DYJetsToLL_M-50_HT-800to1200'] = TChain('tEvent')
DYJets_SubcategoryChainDict_['DYJetsToLL_M-50_HT-1200to2500'] = TChain('tEvent')
DYJets_SubcategoryChainDict_['DYJetsToLL_M-50_HT-2500toInf'] = TChain('tEvent')
SubcategoryChainDictsByCategoryDict['DYJets'] = DYJets_SubcategoryChainDict_
