...
if phase==0:
	pixelXml =       '/nfs/dust/cms/user/kutznerv/disapptrks/track-tag/newpresel3-200-4-short-updated/weights/TMVAClassification_BDT.weights.xml'
	pixelstripsXml = '/nfs/dust/cms/user/kutznerv/disapptrks/track-tag/newpresel2-200-4-medium-updated/weights/TMVAClassification_BDT.weights.xml'
else:
...
for ientry in range(nentries):
    ...
    if not (c.PFCaloMETRatio<5): continue
