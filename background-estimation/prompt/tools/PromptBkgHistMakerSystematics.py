...
parser.add_argument("-v", "--verbosity", type=int, default=100,help="analyzer script to batch")
...
for ientry in range(nentries):
	...
	mindphi = 4
	for jet in adjustedJets[:3]: mindphi = min(mindphi, abs(jet.DeltaPhi(adjustedMht)))            
