...
hTrkPixelDedxScale_charginomatch_SR = TH1F('hTrkPixelDedxScale_charginomatch_SR','Chargino-matched track pixel dedx',2,0,1)
hTrkPixelDedxScale_charginomatch_barrel_SR = TH1F('hTrkPixelDedxScale_charginomatch_barrel_SR','Chargino-matched track pixel dedx at barrel region',300,0,30)
hTrkPixelDedxScale_charginomatch_endcap_SR = TH1F('hTrkPixelDedxScale_charginomatch_endcap_SR','Chargino-matched track pixel dedx at endcap region',300,0,30)
hTrkPixelDedxScaleSmear_charginomatch_barrel = TH1F('hTrkPixelDedxScaleSmear_charginomatch_barrel','Chargino-matched track pixel dedx at barrel region',300,0,30)
hTrkPixelDedxScaleSmear_charginomatch_endcap = TH1F('hTrkPixelDedxScaleSmear_charginomatch_endcap','Chargino-matched track pixel dedx at endcap region',300,0,30)
hTrkPixelDedxScaleSmear_charginomatch_SR = TH1F('hTrkPixelDedxScaleSmear_charginomatch_SR','Chargino-matched track pixel dedx',2,0,1)
