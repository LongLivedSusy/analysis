...
hTrkPixelDedxScale_charginomatch_barrel = TH1F('hTrkPixelDedxScale_charginomatch_barrel','Chargino-matched track pixel dedx at barrel region',100,0,10)
hTrkPixelDedxScale_charginomatch_endcap = TH1F('hTrkPixelDedxScale_charginomatch_endcap','Chargino-matched track pixel dedx at endcap region',100,0,10)
hTrkPixelDedxScaleSmear_charginomatch_barrel = TH1F('hTrkPixelDedxScaleSmear_charginomatch_barrel','Chargino-matched track pixel dedx at barrel region',100,0,10)
hTrkPixelDedxScaleSmear_charginomatch_endcap = TH1F('hTrkPixelDedxScaleSmear_charginomatch_endcap','Chargino-matched track pixel dedx at endcap region',100,0,10)
...
hGenCharginoMass = TH1F('hGenCharginoMass','Gen-chargino mass',1500,0,1500)
...
hMuMu2InvMass = TH1F('hMuMu2InvMass','',200,0,200)
hMuMu2InvMass_ZmassWindow = TH1F('hMuMu2InvMass_ZmassWindow','',200,0,200)
...
hTrkPixelDedxScaleSmear_fromZ_barrel = TH1F('hTrkPixelDedxScaleSmear_fromZ_barrel','',100,0,10)
...
hTrkPixelDedxScaleSmear_fromZ_endcap = TH1F('hTrkPixelDedxScaleSmear_fromZ_endcap','',100,0,10)
