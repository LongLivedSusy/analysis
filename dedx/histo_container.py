...
hTrkPixelDedxScale_fromZ = TH1F('hTrkPixelDedxScale_fromZ','',100,0,10)
hTrkPixelDedxScaleSmear_fromZ = TH1F('hTrkPixelDedxScaleSmear_fromZ','',100,0,10)
...
hTrkPixelDedx_fromZ_SR = TH1F('hTrkPixelDedx_fromZ_SR','',2,0,2)
hTrkPixelDedx_fromZ_barrel_SR = TH1F('hTrkPixelDedx_fromZ_barrel_SR','',2,0,2)
hTrkPixelDedxScale_fromZ_barrel_SR = TH1F('hTrkPixelDedxScale_fromZ_barrel_SR','',2,0,2)
hTrkPixelDedxScaleSmear_fromZ_barrel_SR = TH1F('hTrkPixelDedxScaleSmear_fromZ_barrel_SR','',2,0,2)
hTrkPixelDedx_fromZ_endcap_SR = TH1F('hTrkPixelDedx_fromZ_endcap_SR','',2,0,2)
hTrkPixelDedxScale_fromZ_endcap_SR = TH1F('hTrkPixelDedxScale_fromZ_endcap_SR','',2,0,2)
hTrkPixelDedxScaleSmear_fromZ_endcap_SR = TH1F('hTrkPixelDedxScaleSmear_fromZ_endcap_SR','',2,0,2)
