...
def main(event_tree_filenames, track_tree_output, nevents = -1, treename = "TreeMaker2/PreSelection", verbose = False, iEv_start = False, debug = True, save_cleaned_variables = True):
    ...
    integer_branches = ["PassTrig_MhtMet", "PassTrig_SingleMuon", "PassTrig_SingleElectron", "n_jets", "n_goodjets", "n_btags", "n_leptons", "n_goodleptons", "n_goodelectrons", "n_goodmuons", "n_allvertices", "n_NVtx", "passesUniversalSelection", "passesUniversalDataSelection", "n_genLeptons", "n_genElectrons", "n_genMuons", "n_genTaus"]
	...
	# check if genLeptons are present in event:
        ...
        tree_branch_values["PassTrig_MhtMet"][0] = bool(PassTrig_MhtMet)
        tree_branch_values["PassTrig_SingleMuon"][0] = bool(PassTrig_SingleMuon)
        tree_branch_values["PassTrig_SingleElectron"][0] = bool(PassTrig_SingleElectron)
