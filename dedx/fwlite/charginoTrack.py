...
for i, event in enumerate(events):
	...
	if drmin < threshold: 
	    ...
	    P_chargino.Fill(gp.p())
	    pt_chargino.Fill(gp.pt())
	    eta_chargino.Fill(gp.eta())
	    phi_chargino.Fill(gp.phi())

	    P_track.Fill(matchingTrack.p())
	    pt_track.Fill(matchingTrack.pt())
	    eta_track.Fill(matchingTrack.eta())
	    phi_track.Fill(matchingTrack.phi())
	    pixeldedx_track.Fill(dedxpixel)
	    stripsdedx_track.Fill(dedxstrips)
