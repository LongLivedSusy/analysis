...
if __name__ == '__main__' :
    ...
    draw(inputfile='./output_mediumchunks/Run2016B-SingleMuon.root',
        ...
        fitrangemax=2.8,
        outputdir=outputdir,
	outputfile='Run2016B_TrkPixelDedx_fromZ_endcap.'+format_c)
    ...
    draw(inputfile='./output_mediumchunks/Run2016C-SingleMuon.root',
        ...
        fitrangemax=2.8,
        outputdir=outputdir,
	outputfile='Run2016C_TrkPixelDedx_fromZ_endcap.'+format_c)
    ...
    draw(inputfile='./output_mediumchunks/Run2017C-SingleMuon.root',
        ...
        fitrangemax=2.8,
        outputdir=outputdir,
	outputfile='Run2017C_TrkPixelDedx_fromZ_endcap.'+format_c)
