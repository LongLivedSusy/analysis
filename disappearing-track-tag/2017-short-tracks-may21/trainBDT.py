...
def add_tree(trees, weights, skim_folder, label, n_ntuple_files_sg, n_ntuple_files_bg, equalSgXsec = False):
...
def train(skim_folder, category, is_dxyinformed, use_chi2, phase, equalSgXsec = False, noVetoes = False, n_ntuple_files_sg = -1, n_ntuple_files_bg = -1):
    ...
    for label in labels:
        try:
            add_tree(trees, weights, skim_folder, label, n_ntuple_files_sg, n_ntuple_files_bg, equalSgXsec = equalSgXsec)    
        except:
    ...
    if category == "short":
        ...
        cuts = "tracks_pt>15 && tracks_is_pixel_track==1 && tracks_chi2perNdof>0" + vetoes
    elif category == "long":
        #cuts = "tracks_pt>30 && tracks_is_pixel_track==0 && tracks_passjetveto==1 && tracks_chi2perNdof>0 && tracks_chi2perNdof<999999"
        cuts = "tracks_pt>40 && tracks_is_pixel_track==0 && tracks_chi2perNdof>0" + vetoes
