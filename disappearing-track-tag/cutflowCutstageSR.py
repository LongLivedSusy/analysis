...
def plot_signalregions_cutflow(ntuple, lheader, pdfname, do_sr, numevents = -1, absolute=False, uselog = True, debug = False):
    ...
    for plottype in plottypes:
        ...
        thispdfname = "plots-cutflow/" + pdfname    
...
if __name__ == "__main__":
    ...
    if options.index == 1:
       plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17MiniAODv2.WJetsToLNu*root", "WJetsToLNu bg.", "cutflow_bg.pdf", False, numevents = int(options.numevents), debug = options.debug)
    if options.index == 2:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17MiniAODv2.WJetsToLNu*root", "WJetsToLNu bg.", "cutflow_bg.pdf", False, numevents = int(options.numevents), debug = options.debug, absolute = True)
    if options.index == 3:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T1btbt*root", "T1btbt (m(#tilde{g})=1.5 TeV, m(#tilde{#chi}_{1}^{0})=1.1 TeV)", "cutflow_t1btbt.pdf", False, numevents = int(options.numevents), debug = options.debug)
    if options.index == 4:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T1btbt*root", "T1btbt (m(#tilde{g})=1.5 TeV, m(#tilde{#chi}_{1}^{0})=1.1 TeV)", "cutflow_t1btbt.pdf", False, numevents = int(options.numevents), debug = options.debug, absolute = True)
    if options.index == 5:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T2tb*root", "T2tb (m(#tilde{b})=1 TeV, m(#tilde{#chi}_{1}^{0})=900 GeV)", "cutflow_t2tb.pdf", False, numevents = int(options.numevents), debug = options.debug)
    if options.index == 6:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T2tb*root", "T2tb (m(#tilde{b})=1 TeV, m(#tilde{#chi}_{1}^{0})=900 GeV)", "cutflow_t2tb.pdf", False, numevents = int(options.numevents), debug = options.debug, absolute = True)
    if options.index == 7:
       plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17MiniAODv2.WJetsToLNu*root", "WJetsToLNu bg.", "cutflow_bg.pdf", True, numevents = int(options.numevents), debug = options.debug)
    if options.index == 8:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17MiniAODv2.WJetsToLNu*root", "WJetsToLNu bg.", "cutflow_bg.pdf", True, numevents = int(options.numevents), debug = options.debug, absolute = True)
    if options.index == 9:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T1btbt*root", "T1btbt (m(#tilde{g})=1.5 TeV, m(#tilde{#chi}_{1}^{0})=1.1 TeV)", "cutflow_t1btbt.pdf", True, numevents = int(options.numevents), debug = options.debug)
    if options.index == 10:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T1btbt*root", "T1btbt (m(#tilde{g})=1.5 TeV, m(#tilde{#chi}_{1}^{0})=1.1 TeV)", "cutflow_t1btbt.pdf", True, numevents = int(options.numevents), debug = options.debug, absolute = True)
    if options.index == 11:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T2tb*root", "T2tb (m(#tilde{b})=1 TeV, m(#tilde{#chi}_{1}^{0})=900 GeV)", "cutflow_t2tb.pdf", True, numevents = int(options.numevents), debug = options.debug)
    if options.index == 12:
        plot_signalregions_cutflow("../ntupleanalyzer/skim_cutflowDec21b_merged/RunIIFall17FSv3.SMS-T2tb*root", "T2tb (m(#tilde{b})=1 TeV, m(#tilde{#chi}_{1}^{0})=900 GeV)", "cutflow_t2tb.pdf", True, numevents = int(options.numevents), debug = options.debug, absolute = True)
    if options.index == -1:
        for i in range(12+1)[1:]:
            os.system("./cutflowCutstageSR.py --index %s &" % i)
