...
$VARIABLES
    ...
    if (strcmp(maxTreeEntriesString.c_str(), "-1")) {
        ...
        mycuts=("$PRESELECTION && Entry$<" + maxTreeEntriesString).c_str();
        mycutb=("$PRESELECTION && Entry$<" + maxTreeEntriesString).c_str();
    } else {
        mycuts=("$PRESELECTION");
        mycutb=("$PRESELECTION");
    }
    ...
    factory->BookMethod(TMVA::Types::kBDT, "BDT", "NTrees=$NTREES:MaxDepth=$MAXDEPTH");
